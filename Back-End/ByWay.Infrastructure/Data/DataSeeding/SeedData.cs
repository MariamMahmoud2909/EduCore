...
namespace ByWay.Infrastructure.Data.DataSeeding
{
    public static class SeedData
    {
        public static async Task Initialize(ApplicationDbContext context, UserManager<ApplicationUser> userManager, RoleManager<IdentityRole<int>> roleManager)
        {
            ...
            var categories = new[]
            {
                new Category { Name = "Fullstack Development", Image = "/images/categories/fs.jpg", Description = "Complete web development from frontend to backend", IsActive = true, CreatedAt = DateTime.UtcNow },
                new Category { Name = "Backend Development", Image = "/images/categories/back.jpg", Description = "Server-side development and APIs", IsActive = true, CreatedAt = DateTime.UtcNow },
                new Category { Name = "Frontend Development", Image = "/images/categories/front.jpg", Description = "Client-side web development", IsActive = true, CreatedAt = DateTime.UtcNow },
                new Category { Name = "UX/UI Design", Image = "/images/categories/uiux.jpg", Description = "User experience and interface design", IsActive = true, CreatedAt = DateTime.UtcNow },
                new Category { Name = "Artificial Intelligence", Image = "/images/categories/ai.jpg", Description = "Machine Learning and AI technologies", IsActive = true, CreatedAt = DateTime.UtcNow },
                new Category { Name = "Data Science", Image = "/images/categories/ds.jpg", Description = "Data analysis and visualization", IsActive = true, CreatedAt = DateTime.UtcNow },
                new Category { Name = "Mobile Development", Image = "/images/categories/mobile.jpg", Description = "iOS and Android app development", IsActive = true, CreatedAt = DateTime.UtcNow },
                new Category { Name = "Digital Marketing", Image = "/images/categories/dm.jpg", Description = "Online marketing strategies", IsActive = true, CreatedAt = DateTime.UtcNow },
                new Category { Name = "Cloud Computing", Image = "/images/categories/cloud.jpg", Description = "Cloud platforms and services", IsActive = true, CreatedAt = DateTime.UtcNow },
                new Category { Name = "Cybersecurity", Image = "/images/categories/cs.jpg", Description = "Information security and ethical hacking", IsActive = true, CreatedAt = DateTime.UtcNow }
            };
            ...
            {
                new Instructor { FirstName = "Dr. Ahmed", LastName = "Elsayed", Email = "ahmed.elsayed@gmail.com", Bio = "PhD in Computer Science with 15+ years in software development", JobTitle = JobTitle.FullstackDeveloper, Image = "/images/instructors/ahmed.jpg", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow, IsActive = true },
                new Instructor { FirstName = "Eng. Mohamed", LastName = "Hassan", Email = "mohamed.hassan@gmail.com", Bio = "Senior Backend Engineer specializing in microservices", JobTitle = JobTitle.BackendDeveloper, Image = "/images/instructors/mohamed.jpg", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow, IsActive = true },
                new Instructor { FirstName = "Sarah", LastName = "Mahmoud", Email = "sarah.mahmoud@gmail.com", Bio = "UI/UX Designer with expertise in modern design systems", JobTitle = JobTitle.UXUIDesigner, Image = "/images/instructors/sara.jpg", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow, IsActive = true },
                new Instructor { FirstName = "Omar", LastName = "Ibrahim", Email = "omar.ibrahim@gmail.com", Bio = "Frontend Architect focusing on React and performance optimization", JobTitle = JobTitle.FrontendDeveloper, Image = "/images/instructors/omar.jpg", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow, IsActive = true },
                new Instructor { FirstName = "Dr. Fatma", LastName = "Khalil", Email = "fatma.khalil@gmail.com", Bio = "AI Researcher and Machine Learning expert", JobTitle = JobTitle.AiEngineer, Image = "/images/instructors/fatma.jpg", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow, IsActive = true },
                new Instructor { FirstName = "Karim", LastName = "Nasser", Email = "karim.nasser@gmail.com", Bio = "Data Scientist with expertise in Python and ML algorithms", JobTitle = JobTitle.DataScientist, Image = "/images/instructors/karim.jpg", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow, IsActive = true },
                new Instructor { FirstName = "Mona", LastName = "Farouk", Email = "mona.farouk@gmail.com", Bio = "Mobile Development Lead with Flutter and React Native expertise", JobTitle = JobTitle.MobileDeveloper, Image = "/images/instructors/mona.jpg", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow, IsActive = true },
                new Instructor { FirstName = "Hassan", LastName = "Rashad", Email = "hassan.rashad@gmail.com", Bio = "Digital Marketing Strategist and Growth Hacker", JobTitle = JobTitle.MarketingSpecialist, Image = "/images/instructors/hasan.jpg", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow, IsActive = true },
                new Instructor { FirstName = "Amira", LastName = "Salem", Email = "amira.salem@gmail.com", Bio = "Cloud Solutions Architect with AWS and Azure certifications", JobTitle = JobTitle.CloudEngineer, Image = "/images/instructors/amira.jpg", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow, IsActive = true },
                new Instructor { FirstName = "Ziad", LastName = "Fouad", Email = "ziad.fouad@gmail.com", Bio = "Cybersecurity Expert and Ethical Hacking instructor", JobTitle = JobTitle.SecurityAnalyst, Image = "/images/instructors/ziad.jpg", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow, IsActive = true }
            };
